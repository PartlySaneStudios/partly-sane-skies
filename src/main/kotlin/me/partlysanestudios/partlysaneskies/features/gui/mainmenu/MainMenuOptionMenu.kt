...
class MainMenuOptionMenu(
    ...
    private val backgroundImage =
        ResourceLocation("partlysaneskies", "textures/gui/main_menu/image_3_blurred.png").uiImage.constrain {
            x = CenterConstraint()
            y = CenterConstraint()
            width = 100.percent
            height = 100.percent
    ...
    private val headingText =
        UIWrappedText("Keep the new main menu?", centered = true).constrain {
            x = CenterConstraint()
            y = 30.percent
            width = 40.percent
    ...
    private val yesText =
        UIWrappedText("Yes, keep the new main menu", centered = true).constrain {
            width = 90.percent
            x = CenterConstraint()
            y = 10.percent
            textScale = 1.scaledPixels
    ...
    private val pssExample =
        ResourceLocation("partlysaneskies", "textures/gui/main_menu/selection/pssexample.png").uiImage.constrain {
            x = CenterConstraint()
            y = 25.percent
            width = 90.percent
            height = 70.percent
    ...
    private val sccExample =
        ResourceLocation("partlysaneskies", "textures/gui/main_menu/selection/sccexample.png").uiImage.constrain {
            x = CenterConstraint()
            y = 25.percent
            width = 90.percent
            height = 70.percent
    ...
    private val noText =
        UIWrappedText("No, return to the default menu", centered = true).constrain {
            width = 90.percent
            x = CenterConstraint()
            y = 10.percent
            textScale = 1.scaledPixels
    ...
    private val discordText =
        UIWrappedText("Discord: discord.gg/${PartlySaneSkies.discordCode}")
            .constrain {
                x = 10.scaledPixels
                y = 10.scaledPixels(alignOpposite = true)
                textScale = 1.scaledPixels
