...
class MainMenuOptionMenu(nextRunnable: Runnable) : WindowScreen(ElementaVersion.V5) {
    private val backgroundBox = UIBlock()
        .constrain {
            x = CenterConstraint()
            y = CenterConstraint()
            width = 100.percent
    ...
    private val backgroundImage = ResourceLocation("partlysaneskies", "textures/gui/main_menu/image_3_blurred.png").uiImage
        .constrain {
            x = CenterConstraint()
            y = CenterConstraint()
            width = 100.percent
    ...
    private val transparentBlock = UIBlock()
        .constrain {
            x = CenterConstraint()
            y = CenterConstraint()
            width = 100.percent
    ...
    private val darkerRectangle = UIRoundedRectangle(7.5f)
        .constrain {
            x = CenterConstraint()
    ...
    private val headingText = UIWrappedText("Keep the new main menu?", centered = true)
        .constrain {
            x = CenterConstraint()
            y = 30.percent
            width = 40.percent
    ...
    private val subheadingText = UIWrappedText(
        "You can always disable it later, or find other backgrounds later on in the Partly Sane Skies config. (/pssc)",
        centered = true,
        ).constrain {
            x = CenterConstraint()
            y = 35.percent
    ...
    private val yesButton = UIRoundedRectangle(5.0f)
        .constrain {
    ...
    private val yesText = UIWrappedText("Yes, keep the new main menu", centered = true)
        .constrain {
            width = 90.percent
            x = CenterConstraint()
            y = 10.percent
    ...
    private val pssExample = ResourceLocation("partlysaneskies", "textures/gui/main_menu/selection/pssexample.png").uiImage
        .constrain {
            x = CenterConstraint()
            y = 25.percent
            width = 90.percent
    ...
    private val noButton = UIRoundedRectangle(5.0f)
        .constrain {
            x = CenterConstraint() + 12.percent
            y = 40.percent
            width = 20.percent
    ...
    private val sccExample = ResourceLocation("partlysaneskies", "textures/gui/main_menu/selection/sccexample.png").uiImage
        .constrain {
            x = CenterConstraint()
            y = 25.percent
            width = 90.percent
    ...
    private val noText = UIWrappedText("No, return to the default menu", centered = true)
        .constrain {
            width = 90.percent
            x = CenterConstraint()
            y = 10.percent
