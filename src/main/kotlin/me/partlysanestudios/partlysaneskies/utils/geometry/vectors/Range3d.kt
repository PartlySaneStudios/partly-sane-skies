...
class Range3d(
    ...
    override fun toString(): String = "Range3d(smallCoordinate=$smallCoordinate, largeCoordinate=$largeCoordinate, rangeName='$rangeName')"
}
