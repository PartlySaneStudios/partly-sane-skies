...
object MathUtils {
    ...
    fun randInt(min: Int, max: Int): Int = ThreadLocalRandom.current().nextInt(min, max + 1)
     ...
     */
    fun onCooldown(lastTime: Long, length: Long): Boolean = PartlySaneSkies.time <= lastTime + length
}
