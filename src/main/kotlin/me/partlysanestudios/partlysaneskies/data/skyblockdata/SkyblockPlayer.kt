...
class SkyblockPlayer(val username: String) {
    ...
    private var catacombsExperiencePerLevel =
        intArrayOf(
            50,
            75,
            110,
    ...
    private fun catacombsLevelToExperience(experience: Float): Double {
        ...
        level +=
            (experience - catacombsExperiencePerLevel[level.toInt()]) /
            (catacombsExperiencePerLevel[level.toInt() + 1] - catacombsExperiencePerLevel[level.toInt()])
