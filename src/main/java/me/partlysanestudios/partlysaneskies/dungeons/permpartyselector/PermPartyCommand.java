    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if(args.length == 0 ) {
            ...
            if(args.length == 3) {
                ...
                Utils.sendClientMessage(Utils.colorCodes("&cCorrect usage: /pp add <partyid> <playerusername>\n&7Adds a player to the perm party."));
            }
        }
        ...
        // Remove arg
            ...
            if(args.length == 3) {
                ...
                Utils.sendClientMessage(Utils.colorCodes("&cCorrect usage: /pp remove <partyid> <playerusername>\n&7Removes a player from the perm party."));
            }
        }
        ...
        // List arg
            ...
            if(args.length == 2) {
                ...
                Utils.sendClientMessage(Utils.colorCodes("&cCorrect usage: /pp delete <partyid>\n&7Deletes a perm party. (Note: There is no way to undo this action)."));
            }
        }
            ...
            if(args.length >= 2) {
                ...
                Utils.sendClientMessage(Utils.colorCodes("&cCorrect usage: /pp new <partyid> {partymembers}\n&7Creates a new perm party."));
            }
        }
            ...
            if(args.length == 2) {
                ...
                if(PermPartyManager.favouriteParty != null) {
                    ...
                    Utils.sendClientMessage(Utils.colorCodes("&cCorrect usage: /pp fav {partyid}\n&7Sets party as favourite. If no party is specified, parties everyone in the favourite perm party."));
                }
            ...
            if(PermPartyManager.permPartyMap.containsKey(args[0])) {
                ...
                Utils.sendClientMessage(Utils.colorCodes("&cCorrect usage: /pp <partyid>\n&7Parties everyone in a party."));
            }
        }
    }
