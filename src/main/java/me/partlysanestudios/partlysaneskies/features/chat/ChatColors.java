...
public class ChatColors {
    ...
    public static IChatComponent detectNonMessage(IChatComponent message) {
        if (!PartlySaneSkies.Companion.getConfig().chat.colorNonMessages) {
            return message;
        }
    ...
    public static String getChatColor(String prefix) {
        switch (prefix.toLowerCase()) {
            case "party":
                if (!PartlySaneSkies.Companion.getConfig().chat.colorPartyChat) {
                    return "";
                }
                if (PartlySaneSkies.Companion.getConfig().chat.visibleColors) {
                    return "§6";
                }
                return "§9";

            case "guild":
                if (!PartlySaneSkies.Companion.getConfig().chat.colorGuildChat) {
                    return "";
                }
                if (PartlySaneSkies.Companion.getConfig().chat.visibleColors) {
                    return "§a";
            ...
            case "officer":
                if (!PartlySaneSkies.Companion.getConfig().chat.colorOfficerChat) {
                    return "";
                }
                return "§3";
            ...
            case "to":
            case "from":
                if (!PartlySaneSkies.Companion.getConfig().chat.colorPrivateMessages) {
                    return "";
                }
                return "§d";

            case "co-op":
                if (!PartlySaneSkies.Companion.getConfig().chat.colorCoopChat) {
                    return "";
                }
                return "§b";
