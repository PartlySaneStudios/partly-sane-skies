...
public class BitsShopValue {
    ...
    public static String getString() {
        ...
        boolean filterAffordable = PartlySaneSkies.Companion.getConfig().economy.bitShopOnlyShowAffordable;
    ...
    public void renderInformation(GuiScreenEvent.BackgroundDrawnEvent event) {
        ...
        if (!PartlySaneSkies.Companion.getConfig().economy.bestBitShopItem) {
            return;
        }
