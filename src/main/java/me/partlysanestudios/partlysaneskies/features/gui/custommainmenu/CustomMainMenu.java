...
public class CustomMainMenu extends WindowScreen {
    ...
    public void openCustomMainMenu(GuiOpenEvent e) {
        if (!(PartlySaneSkies.Companion.getConfig().general.customMainMenu))
            return;
    ...
    public void populateGui(float scaleFactor) {
        ...
        if (PartlySaneSkies.Companion.getConfig().general.customMainMenuImage == 0) {
            image = "textures/gui/main_menu/" + imageIdMap.get(MathUtils.INSTANCE.randInt(1, imageIdMap.size()));
        } else
            image = "textures/gui/main_menu/" + imageIdMap.get(PartlySaneSkies.Companion.getConfig().general.customMainMenuImage);

        if (PartlySaneSkies.Companion.getConfig().general.customMainMenuImage == 7) {
        ...
        if (PartlySaneSkies.Companion.getConfig().general.displayAnnouncementsCustomMainMenu) {
    ...
    public static void setMainMenuInfo(Request request) {
        ...
        try {
            if (PartlySaneSkies.Companion.getConfig().general.releaseChannel == 0) {
    ...
    public void onDrawScreen(gg.essential.universal.UMatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (PartlySaneSkies.Companion.getConfig().general.hour24time) {
