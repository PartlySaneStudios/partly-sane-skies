...
public class ModChecker {
    ...
    public static void runOnStartup() {
        new Thread(() -> {
            if (!PartlySaneSkies.Companion.getConfig().general.checkModsOnStartup) {
                return;
            }
    ...
    public static void run() {
        ...
        if (PartlySaneSkies.Companion.getConfig().general.showUpToDateMods) {
    ...
    private static List<KnownMod> read(ModDataJson modData) {
        ...
        for (Map.Entry<String, ModDataJson.ModInfo> entry : modData.getMods().entrySet()) {
            ...
            if (PartlySaneSkies.Companion.getConfig().general.lookForBetaMods) {
