...
public class EnhancedSound {
    ...
    public void onSoundEvent(PlaySoundEvent event) {
        if (event.name.equalsIgnoreCase("note.pling")) {
            if (PartlySaneSkies.Companion.getConfig().skyblock.customSoundOption == 0) {
                return;
            }
            ISound sound = new ISound() {
                @Override
                public ResourceLocation getSoundLocation() {
                    return new ResourceLocation("partlysaneskies", "tenor_" + instruments[PartlySaneSkies.Companion.getConfig().skyblock.customSoundOption - 1]);
                }
        ...
        if (event.name.equalsIgnoreCase("note.bassattack")) {
            ...
            ISound sound = new ISound() {
                @Override
                public ResourceLocation getSoundLocation() {
                    return new ResourceLocation("partlysaneskies", "bass_" + instruments[PartlySaneSkies.Companion.getConfig().skyblock.customSoundOption - 1]);
                }
            ...
            ISound sound = new ISound() {
                @Override
                public ResourceLocation getSoundLocation() {
                    return new ResourceLocation("partlysaneskies", "alto_" + instruments[PartlySaneSkies.Companion.getConfig().skyblock.customSoundOption - 1]);
                }
        ...
        if (event.name.equalsIgnoreCase("random.explode")) {
            if (PartlySaneSkies.Companion.getConfig().skyblock.customExplosion == 0) {
                return;
            }
            else if (PartlySaneSkies.Companion.getConfig().skyblock.customExplosion == 1) {
                event.result = null;
                return;
            }
            ISound sound = new ISound() {
